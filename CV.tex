...
\begin{description}
% \item [xdup] Duplicates an X window using the XDamage signal. This was created
%   in order to duplicate a window for 3d viewers.
%
%   https://github.com/adrianparvino/xdup
...
% \item [Mystltoe] A UTF-8 string library implemented in C. I often reference this
%   to show coding discipline such as Single Responsibility Principle and Apps
%   Hungarian for system-level manipulation.
%
%   \href{https://github.com/adrianparvino/mystltoe}{https://github.com/adrianparvino/mystltoe}

% \item [MyOOS] A hacked-up kernel created in pure NASM in an attempt to fully
%   modularize the kernel. The kernel core is just a module loader and only spans
%   217 lines with whitespace.
%
%   https://github.com/adrianparvino/MyOOS
\end{description}
\end{document}
